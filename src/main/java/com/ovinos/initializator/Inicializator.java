...
public class Inicializator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (sheepRepository.count()==0 && batchRepository.count()==0){
            ...
            Female f1 = new Female("1", sfd.parse("02/01/2026"), batch1);
            Male m1 = new Male("2", sfd.parse("27/12/2025"), batch1);
            Female f2 = new Female("3", sfd.parse("12/02/2026"), batch1);

            Male m2 = new Male("4", sfd.parse("07/12/2025"), batch2);

            sheepRepository.saveAll(Arrays.asList(f1, m1, f2, m2));
        }
